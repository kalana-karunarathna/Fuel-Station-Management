...
exports.createTransaction = async (req, res) => {
  ...
  try {
    ...
    if (relatedAccountId) {
      ...
      if (relatedAccount.user.toString() !== req.user.id) {
    ...
    await transaction.populate('account', 'accountName bankName').execPopulate();
...
exports.updateTransaction = async (req, res) => {
  ...
  try {
    ...
    // Populate account details
    await updatedTransaction.populate('account', 'accountName bankName').execPopulate();
    if (transaction.relatedAccount) {
      await updatedTransaction.populate('relatedAccount', 'accountName bankName').execPopulate();
    }
